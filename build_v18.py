#!/usr/bin/env python3
"""
Build Quail Hatch Video v18 - FINAL
- No emojis (square issue)
- TikTok/YouTube style fonts
- Bold, impactful text
"""
...
OUTPUT = f"{INPUT_DIR}/QuailHatchVideo_v18.mp4"
AUDIO = f"{INPUT_DIR}/ukulele_source.m4a"
WORKSPACE = "/Users/mirzaie/.openclaw/workspace/v18_build"
...
def create_title_card(text, duration=3):
    ...
    for line in lines:
        ...
        # Thick black outline (TikTok style)
...
def create_text_img(text, position="top"):
    """Create TikTok/YouTube style text - bold with thick outline"""
    img = Image.new('RGBA', (TARGET_W, TARGET_H), (0, 0, 0, 0))
    draw = ImageDraw.Draw(img)
    
    try:
        # Larger, bolder font for social media
    ...
    if position == "center":
        ...
        start_y = 150  # Higher up for better framing
...
def build_v18():
    print("Building Quail Hatch Video v18 (TIKTOK STYLE)...")
    ...
    print("\n✅ v18 ready! TikTok style fonts, no emojis.")
