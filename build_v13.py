#!/usr/bin/env python3
"""
Build Quail Hatch Video v13 - FIXED
- Day 1 setup with technical captions
- Flashback to hatching
- NO early brooder (removed IMG_7083)
- Only IMG_6118 at END for brooder finale
- Trimmed "Here we go" to active movement only
"""
...
OUTPUT = f"{INPUT_DIR}/QuailHatchVideo_v13.mp4"
AUDIO = f"{INPUT_DIR}/ukulele_source.m4a"
WORKSPACE = "/Users/mirzaie/.openclaw/workspace/v13_build"
...
def build_v13():
    """Build v13 - fixed storyline."""
    print("Building Quail Hatch Video v13 (FIXED)...")
    ...
    # ===== TRIMMED: Only active hatching movement =====
    print("Scene 8: ACTIVE HATCH (trimmed)")
    # Use 95-105 (10 seconds) - when chick is actively moving
    ...
    # ===== NO IMG_7083 - go straight to brooder finale =====
    
    # ===== BROODER FINALE ONLY =====
    print("Scene 10: Brooder finale")
    ...
    print("\n✅ v13 ready! No early brooder, trimmed hatch scene.")
