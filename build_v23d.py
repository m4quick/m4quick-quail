#!/usr/bin/env python3
"""
Build Quail Hatch Video v23d - WITH LOCAL TRANSITIONS
...
OUTPUT = f"{INPUT_DIR}/QuailHatchVideo_v23d_TRANSITIONS.mp4"
...
def build_v23d():
    print("Building Quail Hatch Video v23d - WITH LOCAL TRANSITIONS")
    print("Using Mac Studio - smooth crossfades + subtle effects")
    ...
    print("\n✅ v23d TRANSITIONS complete!")
    print("Effects: Local crossfade transitions (0.4s fade in/out)")
