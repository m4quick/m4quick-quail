#!/usr/bin/env python3
"""
Build Quail Hatch Video v15 - FIXED TEXT
- Clean text without escape issues
- All captions properly formatted
"""
...
OUTPUT = f"{INPUT_DIR}/QuailHatchVideo_v15.mp4"
AUDIO = f"{INPUT_DIR}/ukulele_source.m4a"
WORKSPACE = "/Users/mirzaie/.openclaw/workspace/v15_build"
...
def build_v15():
    print("Building Quail Hatch Video v15 (FIXED TEXT)...")
    
    clips = []
    
    # Scene 1: Perfect conditions
    ...
    # Scene 5: First hatchlings
    print("Scene 5: First hatchlings")
