#!/usr/bin/env python3
"""
Build Quail Hatch Video v16 - FINAL EDITS
- Shortened "Here we go!" with fade
- Reordered clips (25-29s moved after hatch)
- Title card: "The Miracle of Hatching!" with fade
...
OUTPUT = f"{INPUT_DIR}/QuailHatchVideo_v16.mp4"
AUDIO = f"{INPUT_DIR}/ukulele_source.m4a"
WORKSPACE = "/Users/mirzaie/.openclaw/workspace/v16_build"
...
def build_v16():
    print("Building Quail Hatch Video v16 (FINAL EDITS)...")
    ...
    # === ACTIVE HATCH - SHORTENED ===
    print("Scene 7: Here we go! (shortened)")
    # Shortened to 4 seconds with fade
    ...
    # Add fade out to next scene
    hatch_scene = hatch_scene.fadeout(0.5)
    clips.append(hatch_scene)
    hatch_clip.close()
    
    # === FIRST HATCHLINGS - MOVED HERE (was 25-29s) ===
    print("Scene 8: First hatchlings (moved after main hatch)")
